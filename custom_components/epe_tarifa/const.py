...
SENSORS = [
    ...
    ("kwh_red_periodo", "EPE kWh red período", "kWh", "mdi:transmission-tower", "energy", "total", 2),
    ...
    ("kwh_trifasica_dia", "EPE kWh trifásica por día (est.)", "kWh", "mdi:engine", "energy", "total", 3),
    ("kwh_red_dia_estimado", "EPE kWh red día (est.)", "kWh", "mdi:transmission-tower", "energy", "total", 2),
    ("costo_epe_dia", "EPE costo energía día", "ARS", "mdi:cash", "monetary", "total", 0),
    ("costo_ahorro_dia", "EPE costo ahorrado día", "ARS", "mdi:hand-coin", "monetary", "total", 0),
    ("costo_consumo_dia", "EPE costo consumo hogar día", "ARS", "mdi:home-lightning-bolt", "monetary", "total", 0),
    ("blended", "EPE precio medio ($/kWh, est.)", "ARS/kWh", "mdi:cash-multiple", None, "measurement", 2),
    ("total_proyectado_periodo", "EPE total proyectado período", "ARS", "mdi:calculator", "monetary", "total", 0),
    ("kwh_red_proyectado", "EPE kWh red proyectados período", "kWh", "mdi:transmission-tower", "energy", "total", 2),
    ("total_factura_periodo", "EPE total última factura", "ARS", "mdi:file-document", "monetary", "total", 0),
    ...
    ("kwh_factura_meter", "EPE kWh medidor última factura", "kWh", "mdi:counter", "energy", "total", 0),
    ("dolar_oficial", "EPE dólar oficial (venta)", "ARS", "mdi:currency-usd", None, "measurement", 2),
    ("inversion_total_usd", "EPE inversión total", "USD", "mdi:solar-panel", "monetary", "total", 2),
    ("inversion_total_ars", "EPE inversión total (ARS)", "ARS", "mdi:solar-panel", "monetary", "total", 0),
    ("ahorro_acumulado_usd", "EPE ahorro acumulado", "USD", "mdi:hand-coin", "monetary", "total", 2),
